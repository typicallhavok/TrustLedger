...
import (
    ...
    fabsdkconfig "github.com/hyperledger/fabric-sdk-go/pkg/core/config"  // Alias for fabric-sdk-go config
    "github.com/hyperledger/fabric-sdk-go/pkg/gateway"
    "github.com/joho/godotenv"

    "github.com/sampriti/evidence-api/api/config"  // Your local config package
)
...
func connectGateway() (*gateway.Contract, error) {
    ...
    gw, err := gateway.Connect(
        gateway.WithConfig(fabsdkconfig.FromFile(connectionPath)),  // Use fabsdkconfig.FromFile
